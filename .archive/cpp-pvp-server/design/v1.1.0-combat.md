...
**클래스 구조 (`include/pvpserver/game/combat.h`):**
```cpp
...
**클래스 구조 (`include/pvpserver/game/projectile.h`):**
```cpp
class Projectile {
public:
    ...
    static double Lifetime() noexcept;   // 1.5초
...
**데이터 구조 (`include/pvpserver/game/combat.h`):**
```cpp
