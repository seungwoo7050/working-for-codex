...
| 항목 | 내용 |
|------|------|
| **기술 스택** | Java 21, Spring Boot 3.3.5, Gradle 8.5, H2/PostgreSQL, JPA, WebFlux, R2DBC |
| **핵심 학습** | 레이어드 아키텍처, 트랜잭션, RBAC, 캐싱, 배치, 검색, 리액티브, Virtual Threads |
| **예상 기간** | 4주 |
| **난이도** | ⭐⭐⭐⭐ |
| **빌드 상태** | ✅ 빌드/테스트 완료 (2025-12-09) |
